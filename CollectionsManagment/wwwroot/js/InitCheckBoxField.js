...
/*<input type="checkbox" class="form-check-input" data-val="true" data-val-required="The StringForFirstBoolField field is required." id="StringForFirstBoolField" name="StringForFirstBoolField" value="true">*/