...
namespace CollectionsManagment.DataBase.Migrations
{
    ...
    [Migration("20230716195950_intermediateTable1")]
    partial class intermediateTable1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemTag", b =>
                {
                    b.HasOne("CollectionsManagment.DataBase.Entities.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CollectionsManagment.DataBase.Entities.Tag", null)
                        .WithMany()
